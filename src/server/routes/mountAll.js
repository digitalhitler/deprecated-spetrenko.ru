...
module.exports = function mountAllModules(server) {
  for(let curr in routeModules) {
    let routeHandler = require(routeModules[curr]);
    server.route(routeHandler);
 //   console.log('mounted ' + routeModules[curr]);
  }
};
