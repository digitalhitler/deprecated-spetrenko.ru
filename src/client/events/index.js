...
* @Date:   2016-05-24T10:05:28+03:00
* @Email:  spetrenko@me.com
* @Project: spetrenko.ru
* @Last modified by:   getrix
* @Last modified time: 2016-05-24T10:39:23+03:00
...
export default function bindApplicationEvents(app) {
  
  app.on('pageWillChange', function() {
    console.info('pageWillChange triggered');
  });
}
