...
class StoredSingleton {
  constructor(singletonName) {
    this.__instanceName = singletonName;
    return this.instance;
  }

  get instance() {
    if(!this.__instanceName) {
      throw new Error("Can't use StoredSingleton instance: instanceName is" + " not defined");
    }
    let result = this.storeScope[this.__instanceName] || this;
...
//
//class StoredSingletonEmitter extends StoredSigneton {
//
//}

export { StoredSingleton as StoredSingleton };
//export { StoredSingletonEmitter as StoredSingletonEmitter };
export default StoredSingleton;
