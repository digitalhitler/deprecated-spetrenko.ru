...
const Routedir = path.normalize(__dirname, '../../routes/');

module.exports = function Routemap(App) {

  'use strict';
  let RoutemapHandler = function(App) {
    this.App = App;
    return this;
  }

  RoutemapHandler.prototype.loadRoute = function(Routename) {
    let Route = require(`${Routedir}/${Routename}`);
    App.use(Route.root, Route.router);
  }

  return new RoutemapHandler(App);
